...
function createTables() {
    ...
    executor.hasResults(check_post_if_exist_query).then(
        ...
        console.log("Comment table doesn't exists! Going to create");
        const create_post_query = "CREATE TABLE `PostDetails` ( `ID` bigint(20) NOT NULL, `BODY` varchar(1000) DEFAULT NULL, KEY`ID`(`ID`), CONSTRAINT`PostDetails_ibfk_1` FOREIGN KEY(`ID`) REFERENCES`UserDetails`(`ID`))";
